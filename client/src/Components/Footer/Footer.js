  ...
  return (
    <footer className="footer">
      ...
      <div className="below-footer">
        <p>
          You can reach me at{" "}
          <a className="mail-links" href="mailto:manmeetkaur7720@gmail.com">
        ...
        <p>
          <a
            ...
            href="https://www.linkedin.com/in/manmeet-kaur7720/"
            target="_blank"
          ...
          <a
            className="contact-links"
            href="https://github.com/Manmeet7720"
            target="_blank"
            rel="noopener noreferrer"
          >
